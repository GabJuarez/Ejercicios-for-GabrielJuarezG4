Proceso Ejercicio9
		...
		Escribir "Ingrese el número de filas de la matriz 1: ";
		Leer filas1;
		Escribir "Ingrese el número de columnas de la matriz 1: ";
		Leer columnas1;
		
		Escribir "Ingrese el número de filas de la matriz 2: ";
		Leer filas2;
		Escribir "Ingrese el número de columnas de la matriz 2: ";
		Leer columnas2;
		
		Si columnas1 <> filas2 Entonces
			Escribir "No se puede multiplicar debido a sus dimensiones";
		Sino
